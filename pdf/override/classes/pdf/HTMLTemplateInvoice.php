...
class HTMLTemplateInvoiceCore extends HTMLTemplate
{
    ...
    public function getContent()
    {
        ...
        if (isset($this->order->id_address_delivery) && $this->order->id_address_delivery) {
            ...
            $phone = strlen($delivery_address->phone_mobile) > 0 ? $delivery_address->phone_mobile : $delivery_address->phone;

            $formatted_delivery_address = '<b>'.$delivery_address->firstname . ' ' . $delivery_address->lastname. '</b><br/>'.$phone . '<br/>'.$delivery_address->city . ', '.$delivery_address->address1;
        }
